...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myCounter2 = (TextView) findViewById(R.id.RandomFreq);
        ...
        switch1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                float val = (isChecked) ? 1.0f : 0.0f; // value = (get value of isChecked, if true val = 1.0f, if false val = 0.0f)
                sendFloatPD("switch1", val); //send value to patch, receiveEvent names onOff
    ...
    private PdReceiver receiver1;

    {
        receiver1 = new PdReceiver() {
    ...
    private PdReceiver receiver2;

    {
        receiver2 = new PdReceiver() {
    ...
    private void initPD() throws IOException {
        ...
        dispatcher.addListener("sendFrequency",receiver2);
